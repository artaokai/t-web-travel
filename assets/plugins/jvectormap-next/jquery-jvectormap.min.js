...
Array.prototype.indexOf || (Array.prototype.indexOf = function (searchElement, fromIndex) {
    ...
    jvm.VMLPathElement.pathSvgToVml = function (path) {
        ...
        return path = path.replace(/(-?\d+)e(-?\d+)/g, "0"),
            path.replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function (segment, letter, coords, index) {
                ...
                if (void 0 === this.params.min || void 0 === this.params.max)
                    for (cc in values)
                        val = parseFloat(values[cc]),
                            val > max && (max = val),
                            val < min && (min = val);
                void 0 === this.params.min ? (this.scale.setMin(min),
    ...
    jvm.Region = function (config) {
        ...
        this.config = config,
            ...
            }, wrapper).addClass("jvectormap-region jvectormap-element"),
        ...
        setFocus: function (config) {
            ...
            if (config = config || {},
                ...
                for (i = 0; i < codes.length; i++)
                    this.regions[codes[i]] && (itemBbox = this.regions[codes[i]].element.shape.getBBox()) && (void 0 === bbox ? bbox = itemBbox : (newBbox = {
